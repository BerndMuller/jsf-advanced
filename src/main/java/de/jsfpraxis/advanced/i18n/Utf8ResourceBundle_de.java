 ...
 *
 */
public class Utf8ResourceBundle_de extends ResourceBundle {

    private static final String BUNDLE_NAME = "de.jsfpraxis.advanced.i18n.utf8_de";

    public Utf8ResourceBundle_de() {
